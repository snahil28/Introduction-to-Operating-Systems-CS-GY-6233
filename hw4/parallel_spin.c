...
int main(int argc, char **argv) {
 ...
 /***********************************************************************************************************
 * The time for insertion (averaged over 10 iterations) using spinlocks for 8 threads (1 per CPU core)		*
 * was ~0.036498 seconds, compared to ~0.047718 seconds using mutexes for 8 threads. 						*
